  ...
  return (
    <div className="flex text-black flex-wrap items-center justify-between p-2 bg-gray-100 rounded-lg m-8 gap-4">
      ...
      <div className="relative">
        ...
        <input type="date" name="dateFrom" value={filters.dateFrom} onChange={handleChange} className="p-2 border rounded" />
      </div>

      {/* Date To */}
      <div className="relative">
        <label className="block text-gray-700 text-sm font-bold mb-2">Date To</label>
        <input type="date" name="dateTo" value={filters.dateTo} onChange={handleChange} className="p-2 border rounded" />
      </div>
