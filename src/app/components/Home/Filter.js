...
//           <select name="category" value={filters.category} onChange={handleChange} className="p-2  rounded">
//             <option value="">All</option>
//             {categories[filters.category].map((title) => (
...
//         <select name="type" value={filters.type} onChange={handleChange} className="p-2  rounded">
//           <option value="">All</option>
...
//             className="block w-full bg-white text-gray-700 py-2 px-4 rounded focus:outline-none"
//           >
...
//         <div className="relative flex-2">
//           <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="salaryOrder">
//             Sort Salary
//           </label>
//           <select
//             id="salaryOrder"
//             name="salaryOrder"
//             value={filters.salaryOrder}
//             onChange={handleChange}
//             className="block w-full bg-white text-gray-700 py-2 px-4 rounded focus:outline-none"
//           >
...
//         <select name="experience" value={filters.experience} onChange={handleChange} className="p-2  rounded">
//           <option value="">All</option>
...
//       {/* Date From */}
//       <div className="relative">
//         <label className="block text-gray-700 text-sm font-bold mb-2">Date From</label>
//         <input type="date" name="dateFrom" value={filters.dateFrom} onChange={handleChange} className="p-2  rounded" />
//       </div>

//       {/* Date To */}
//       <div className="relative">
//         <label className="block text-gray-700 text-sm font-bold mb-2">Date To</label>
//         <input type="date" name="dateTo" value={filters.dateTo} onChange={handleChange} className="p-2  rounded" />
//       </div>
