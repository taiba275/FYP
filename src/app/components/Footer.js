    ...
    <div className="max-w-screen-xl mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-10">
            ...
            <div className="flex space-x-10">
                ...
                <div className="flex flex-col space-y-3 font-bold">
                    <a href="#" className="text-lg hover:text-gray-600">Directory</a>
                    <a href="#" className="text-lg hover:text-gray-600">Conferences</a>
                </div>
                <div className="flex flex-col space-y-3 font-bold">
                    <a href="#" className="text-lg hover:text-gray-600">FAQs</a>
                    <a href="#" className="text-lg hover:text-gray-600">About Us</a>
                    <a href="#" className="text-lg hover:text-gray-600">Contact Us</a>
                </div>
            </div>
        </div>
        <div className="flex items-center space-x-4">
            <a href="#" className="bg-gray-100 hover:bg-gray-200 text-sm px-4 py-2 rounded-md">Next Conferences: Berlin, Mumbai & Tokyo</a>
        </div>
    </div>
