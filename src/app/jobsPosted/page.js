  ...
  <div className="flex flex-col items-center justify-center">
    ...
    {loading ? (
      <div className="w-full h-[50vh] flex flex-col justify-center items-center bg-white">
        ...
        <p className="text-gray-500 text-base">Please wait while we fetch them</p>
      </div>
    ) : (
      <>
        ...
        {filteredJobsPosted.length === 0 ? (
          <p className="text-gray-600 text-center m-36 p-12">
            You haven’t posted a job yet <br />
